...
<div id="contenant" class="<?php echo $classpage; ?> second">
  <!--  BANNIERE   chercher l'image de fond dans le dossier -->
  <?
  if ((isset($node) && $node->type == 'pages')|| (isset($node) &&  $node->type == 'equipe')) {
		 $imglist='';
		...
		//display background image and texte hover
		 print '<div class="ban_second" style=" background:url(/'.$img_folder.$image.' ) no-repeat center center fixed;-webkit-background-size: cover; -moz-background-size: cover;  -o-background-size: cover;  background-size: cover;" border=0></div>';
  }
 ?>
  ...
  <div class="wrap">
        ...
        <?php if ($page['sidebar_second']): ?><div id="sidebar_second"><?php print render($page['sidebar_second']); ?></div><?php endif; ?>
